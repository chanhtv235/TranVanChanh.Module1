...
function addNewEmployee() {
    ...
    do {
        checkStatus=true;
        employee.setIdCard(prompt("2.Enter ID Card employee"));
        if (/[\d]{9}/.test(employee.getIdCard())){
            checkStatus=false
        }
    }while(checkStatus);
    //////////////////////////////////////////////////////////
    ...
    do {
        checkStatus=true;
        employee.setBirthDay(prompt("3.Enter Birthday employee"));
        let patt=/([0][1-9]|[1-2][0-9]|[3][0-1])\/([0][1-9]|[1][0-2])\/([1-2][\d]{3})/;
        if (patt.test(employee.getBirthDay())) {
            checkStatus=false
        }
    }while(checkStatus);
    ...
    do {
        checkStatus=true;
        employee.setEmail(prompt("4.Enter Email employee"));
        let patt=/[\w]+@[a-z]+\.[a-z]+/;
    ...
    employee.setAddress(prompt("5.Enter address employee"));
    employee.setPosition(prompt("6.Enter position employee"));

    ////////////////////////////////////////////////////////////////////

    let infoEmployee = [];
    infoEmployee[0] = employee.getName();
    infoEmployee[1]=employee.getIdCard();
    infoEmployee[2]= employee.getBirthDay();
    infoEmployee[3]= employee.getEmail();
    infoEmployee[4]=employee.getAddress();
    infoEmployee[5]=employee.getPositon();
    infoEmployee[6]=employee.getSalary();

    arrlistEmployee.push(infoEmployee);
